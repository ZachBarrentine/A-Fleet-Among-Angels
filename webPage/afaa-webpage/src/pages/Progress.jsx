    ...
    <div>
        ...
        <div className="pBodyBox">
            <p className="pBodyText">
                {/* <span className="nameHighlight">A Fleet Among Angels</span> is actively under development. The game is still in the <span className="boldText">early stages</span> of development.  */}
            <br/> *We are working to have the game completed by EOY 2025. Below is some of our progress:<br></br>
        ...
        {/* <p className="pBodyText"> */}
        <span className="monthTitle">September</span>
        {/* </p> */}
    </div>
    );
}
