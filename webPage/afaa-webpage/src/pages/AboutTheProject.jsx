    ...
    return (
        ...
        <><div className="TitleBox2">
            <h1 className="projectTitle">About the Project</h1>
                ...
                <li>We are a development team composed of <span className="highlightBlue">five undergraduate members</span>.</li>
                ...
                <li>Of the five members, two are pursuing <span className="highlightBlue">computer science</span>, one is pursuing <span className="highlightGreen">graphic design</span>, and two are pursuing <span className="highlightGreen">business</span>.</li>
                </ul>
